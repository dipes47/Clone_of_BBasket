function navbar(){
    ...
    <div class="three">
        <div class="location"><i class="fas fa-map-marker-alt"></i> <span>560004, Bangalore <i class="fas fa-angle-down"></i></span> <i class="far fa-user"></i><a href="./login.html" id ="loginbutton">Login/Sign Up</a><div id="name"></div></div>
